...
namespace PiizzaPan.DataAccessLayer.Migrations
{
    ...
    [Migration("20230724092256_mig_db")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Piizzapan.EntityLayer.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Piizzapan.EntityLayer.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Piizzapan.EntityLayer.Concrete.Category", b =>
                {
            ...
            modelBuilder.Entity("Piizzapan.EntityLayer.Concrete.Contact", b =>
                {
            ...
            modelBuilder.Entity("Piizzapan.EntityLayer.Concrete.ContactUs", b =>
                {
            ...
            modelBuilder.Entity("Piizzapan.EntityLayer.Concrete.Gallery", b =>
                {
            ...
            modelBuilder.Entity("Piizzapan.EntityLayer.Concrete.SocialMedia", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Piizzapan.EntityLayer.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Piizzapan.EntityLayer.Concrete.AppUser", null)
                        .WithMany()
